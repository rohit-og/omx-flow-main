    ...
    <div class="row mt-3" x-data="{isAdvanceBot:'interactive',botFlowUid:null}">
        ...
        <div class="col-xl-12 mb-3">
            <div class="mt-5">
                ...
                data-target="#lwAddNewAdvanceBotReply"> {{ __tr('Simple Chatbot') }}</button>
                <button type="button" @click="isAdvanceBot = 'media'"  class="dropdown-item btn" data-toggle="modal"
                data-target="#lwAddNewAdvanceBotReply"> {{ __tr('Media Chatbot') }}</button>
                <button type="button" @click="isAdvanceBot = 'interactive'"  class="dropdown-item btn" data-toggle="modal"
                data-target="#lwAddNewAdvanceBotReply"> {{ __tr('Advance Interactive Chatbot') }}</button>
                </div>
            </div>
