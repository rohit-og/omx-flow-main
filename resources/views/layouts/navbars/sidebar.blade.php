...
<li class="nav-item">
    <a class="nav-link {{ markAsActiveLink('vendor.user.read.list_view') }}"
       href="{{ isWhatsAppBusinessAccountReady() ? route('vendor.user.read.list_view') : '#' }}"
       @if (!isWhatsAppBusinessAccountReady())
           onclick="alertAndRedirect(event, '{{ route('vendor.settings.read', ['pageType' => 'whatsapp-cloud-api-setup']) }}')"
       @endif>
...
<li class="nav-item">
    <a class="nav-link {{ markAsActiveLink('subscription.read.show') }}"
       href="{{ isWhatsAppBusinessAccountReady() ? route('subscription.read.show') : '#' }}"
       @if (!isWhatsAppBusinessAccountReady())
           onclick="alertAndRedirect(event, '{{ route('vendor.settings.read', ['pageType' => 'whatsapp-cloud-api-setup']) }}')"
       @endif>
...
<!-- This is the main Setup dropdown (UNRESTRICTED) -->
<li class="nav-item">
    ...
    <div class="collapse @if(!isWhatsAppBusinessAccountReady()) show @endif lw-expandable-nav" id="vendorSettingsNav">
        <ul class="nav nav-sm flex-column">
            ...
            <!-- Basic, AI, API get restricted if WhatsApp setup isn't done -->
            <li class="nav-item">
                <a class="nav-link nav-link-ul {{ (isset($pageType) && $pageType == 'general') ? 'active' : '' }}"
                   href="{{ isWhatsAppBusinessAccountReady() ? route('vendor.settings.read', ['pageType' => 'general']) : '#' }}"
                   @if (!isWhatsAppBusinessAccountReady())
                       onclick="alertAndRedirect(event, '{{ route('vendor.settings.read', ['pageType' => 'whatsapp-cloud-api-setup']) }}')"
                   @endif>
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ __tr('Basic') }}
            ...
            <li class="nav-item">
                <a class="nav-link nav-link-ul {{ (isset($pageType) && $pageType == 'ai-chat-bot-setup') ? 'active' : '' }}"
                   href="{{ isWhatsAppBusinessAccountReady() ? route('vendor.settings.read', ['pageType' => 'ai-chat-bot-setup']) : '#' }}"
                   @if (!isWhatsAppBusinessAccountReady())
                       onclick="alertAndRedirect(event, '{{ route('vendor.settings.read', ['pageType' => 'whatsapp-cloud-api-setup']) }}')"
                   @endif>
            ...
            <li class="nav-item">
                <a class="nav-link nav-link-ul {{ (isset($pageType) && $pageType == 'api-access') ? 'active' : '' }}"
                   href="{{ isWhatsAppBusinessAccountReady() ? route('vendor.settings.read', ['pageType' => 'api-access']) : '#' }}"
                   @if (!isWhatsAppBusinessAccountReady())
                       onclick="alertAndRedirect(event, '{{ route('vendor.settings.read', ['pageType' => 'whatsapp-cloud-api-setup']) }}')"
                   @endif>
