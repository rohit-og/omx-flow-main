...
<div class="container-fluid">
    ...
    <div class="col-xl-12 p-0">
        <!-- breadcrumbs -->
        <nav aria-label="breadcrumb" class="lw-breadcrumb-container bg-white">
            <ol class="breadcrumb bg-transparent text-light p-0 m-0">
                <li class=" breadcrumb-item mb-3">
                    <a class="text-decoration-none" href="{{ route('central.vendors') }}">{{ __tr('Manage Users')
                        }}</a>
...
@if(hasCentralAccess())
    <div class="col-xl-12 pl-1">
        <div class="">
            <div class="card-body">
                <fieldset class="mb-5">
                    <legend>{{ __tr('User Details') }}</legend>
                     <div class="col-xl-12 ">
                    ...
                    <div class="my-2 ">
                        <h4 class="text-dark font-weight-bold">{{ __tr('User Title:') }}</h4>
