    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            <x-lw.datatable data-page-length="100" id="lwManualSubscriptionList"
                ...
                <th data-template="#manualSubscriptionVendorColumnTemplate" data-name="null">{{ __tr('User') }}</th>
                ...
                <th data-orderable="true" data-name="charges">{{ __tr('Charges') }}</th>
                <th data-orderable="true" data-name="charges_frequency">{{ __tr('Subscription') }}</th>
