...
class TranslationController extends BaseController
{
    ...
    public function lists($languageId)
    {
        ...
        $hasTranslationData='';
        $hasNoTranslationData='';
          //check to manage tabs data count
        foreach ($processReaction['data']['translations'] as $translationsItemKey => $translationsItem){
             //check for translated data count 
            if((strlen($translationsItem->getTranslation()))> 0){
                $hasTranslationData=true;
                // $hasNoTranslationData =false ;
            }
             //check for untranslated data count 
             if(strlen(!$translationsItem->getTranslation())==0){
        ...
        return $this->loadManageView(
            ...
            [
                ...
                'hasTranslationData' =>$hasTranslationData,   //check for translated data count 
               'hasNoTranslationData' => $hasNoTranslationData,  //check for untranslated data count 
